...
#ifndef WEATHERAPP_API_SWIFT_H
#define WEATHERAPP_API_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="weatherApp_API",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14weatherApp_API11AppDelegate")
...
SWIFT_CLASS("_TtC14weatherApp_API25CitiesTableViewController")
...
@interface Location (SWIFT_EXTENSION(weatherApp_API))
...
SWIFT_CLASS("_TtC14weatherApp_API28LocationsTableViewController")
@interface LocationsTableViewController : UITableViewController <UISearchBarDelegate>
...
SWIFT_CLASS("_TtC14weatherApp_API13SceneDelegate")
...
SWIFT_CLASS("_TtC14weatherApp_API27WeatherDetailViewController")
